...
export const ArticleGenerator: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      await generateAndDownloadDocx(content);
      alert("Berhasil! File DOCX sedang diunduh.");
    } catch (e: any) {
      console.error(e);
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button
            ...
            style={{ padding: '14px', fontSize: '14px', fontWeight: 600, marginTop: '8px' }}
          >
            {isGenerating ? (
              <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                ...
                AI Sedang Menulis Artikel (~60 detik)...
              </span>
            ) : (
